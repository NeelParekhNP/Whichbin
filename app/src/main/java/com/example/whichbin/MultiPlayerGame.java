...
public class MultiPlayerGame extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainMenu = findViewById(R.id.button_menu);
        winnerTextView= findViewById(R.id.textView_winner_text);
        player1View = findViewById(R.id.p1TextView);
        player2View = findViewById(R.id.p2TextView);
        player1Score = findViewById(R.id.textView_player1_score);
        player2Score = findViewById(R.id.textView_player2_score);
        player1QuestionNumber = findViewById(R.id.textView_player1_question_number);
        player2QuestionNumber = findViewById(R.id.textView_player2_question_number);
        countdown1 = findViewById(R.id.textview_countdown_1);
        countdown2 = findViewById(R.id.textview_countdown_2);
        player1Group= findViewById(R.id.radio_group1);
        player2Group= findViewById(R.id.radio_group2);
        player1RB1 = findViewById(R.id.radio_button1_option1);
        player1RB2 = findViewById(R.id.radio_button1_option2);
        player1RB3 = findViewById(R.id.radio_button1_option3);
        player1RB4 = findViewById(R.id.radio_button1_option4);
        player2RB1 = findViewById(R.id.radio_button2_option1);
        player2RB2 = findViewById(R.id.radio_button2_option2);
        player2RB3 = findViewById(R.id.radio_button2_option3);
        player2RB4 = findViewById(R.id.radio_button2_option4);
        mainMenu = findViewById(R.id.button_menu);
